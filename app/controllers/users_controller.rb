...
class UsersController < ApplicationController
  ...
  before_action :require_same_user, only: %i[edit update require_same_user]
  ...
  def create
    ...
    if @user.save
      ...
      flash[:notice] =
        "Welcome to the blog, #{@user.username}! You have succesfully registered and are ready to start writing."
